          ...
          <Grid item xs={8}>
            ...
            <Box>
              <Typography variant="subtitle1" align="justify">
                ...
                native HTML / CSS / JS (build end to end Network Software) ,
                well knowledge in IoT System Design and cloud integration with
                AWS , certified Machine Learning / Deep learning Specification ,
                past experience in Manufacturing (Lean Brown Belt Certified)
              </Typography>
            </Box>
          </Grid>
